...
public class TestLambdas {
	...
	public void test_function() {
		...
		IntUnaryOperator cuadrado = (int a) -> a*a;
	...
	public void test_funcion_2() {
		...
		LongBinaryOperator menor = (long a, long b) -> a < b ?a :b;
